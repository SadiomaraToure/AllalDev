...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="row" style="margin-bottom: 20px;">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h3>Edit Admin ALAL: {{ $admin->prenom.' '.$admin->nom }}</h3>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="telephone" value="{{ $admin->telephone }}" class="form-control">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
  ...
  <option value="F">Feminin</option>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="matricule" value="{{ $admin->matricule }}" class="form-control">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
